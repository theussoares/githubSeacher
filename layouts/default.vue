...
<template>
    <div :class="{ 'dark': themeStore.isDarkMode }">
        <div class="dark:bg-primaryBlueLight bg-primaryBlueDark text-white w-full flex justify-center">
            <div class="flex md:w-4/5 w-full">
                <div class="flex justify-between w-full p-5">
                    <div class="flex gap-6">
                        <button class="font-medium"><NuxtLink to="/"> Searcher </NuxtLink></button>
                        <button class="font-medium"><NuxtLink to="/ratePage"> Rate us </NuxtLink></button>
                    </div>
                    <div>
                        <button v-on:click="themeStore.toggleDarkMode" class="flex items-center gap-2">
                            <p class="text-2lg text-white">LIGHT</p>
                            <svg class="fill-white" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="20" viewBox="0 0 50 50">
